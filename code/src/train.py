...
from lib.utils import load_model_opt, save_models, load_npz
...
def parse_args():
    ...
    # Training settings(arguments from .yml file and input arguments)
...
def main(args):
    ...
    if args.resume_epoch != 1:
        ...
        netG, netD, netC, optimizerG, optimizerD = load_model_opt(netG, netD, netC, optimizerG, optimizerD, path,
                                                                  args.multi_gpus)
